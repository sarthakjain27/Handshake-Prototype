        ...
        <Card border="primary">
          <Card.Body>
            <Card.Title>
              ...
              {this.capitalize(this.props.job.job_title)} - {this.capitalize(this.props.job.city)}, {this.capitalize(this.props.job.state)}, {this.capitalize(this.props.job.country)}
            </Card.Title>

        ...
        <Card border="primary">
          <Card.Body>
            ...
            <Card.Subtitle className="mb-2 text-muted">
              {this.capitalize(this.props.experience.title)} | {showDate}<br />
              {this.capitalize(this.props.experience.city)}, {this.capitalize(this.props.experience.state)}, {this.capitalize(this.props.experience.country)}
            </Card.Subtitle>
            <Card.Text>

const signup = (req, res, bcrypt, saltRounds, databaseConnection) => {
  ...
  databaseConnection.query(alreadyPresentSql, (err, searchResult) => {
    if (err) throw err;
    if (searchResult.length > 0) {
      ...
      bcrypt.hash(password, saltRounds, (error, hash) => {
        ...
        databaseConnection.query(insertSql, (insertError, result) => {
